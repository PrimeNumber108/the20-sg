  ...
  return (
    <div>
      <div className="max-w-screen-xl mx-auto mt-10">
        <h1 className="lg:text-[64px] text-5xl leading-none mt-28 mb-10 lg:mb-20 text-center lg:text-left ">
          What we do
        </h1>
        ...
        <div className="">
          ...
          <div className="grid grid:cols-1 md:grid-cols-3 gap-4 mt-10 mx-5 md:mx-0">
            <div className="p-5 border">
              ...
              <p className="mt-5">
                We provide market making service with focus on developing markets. We have connected with most
                high-volume exchanges, especially in the Cryptocurrency field.
              </p>
            </div>
            <div className="p-5 border">
              <img src="/images/service/icon-eye.png" alt="dashboard" />
              <p className="mt-5">
                We look deep into order book and maintain close spread. Stem rom TradFi, our models are tested on a very
                wide range of historical data and assets.
              </p>
            </div>
            <div className="p-5 border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3  gap-4 mt-10 mx-5 md:mx-0">
            ...
            <div className="">
              <div className="p-5 border md:mt-40 h-52">
                ...
                <p className="mt-5">For inquires, please fill the contact form or email us at admin@the20.sg</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-12 gap-4 h-full py-10">
                ...
                <div className="col-span-6 flex items-end">
                  <div className="w-96 text-[#484848] text-sm lg:text-xl">
                    <p>
                      If you are project owner and looking for equity/token funding, reach out to use via the contact
                      form or email to admin@the20.sg
                    </p>
                    <button
                      type="button"
                ...
                <div className="col-span-4 text-[#484848] text-xl lg:text-[32px] leading-tight">
                  We maintain a wide range of portfolio acorss asset groups and venture investments
                </div>
                <div className="col-span-0 md:col-span-1"></div>
              </div>
            </div>
