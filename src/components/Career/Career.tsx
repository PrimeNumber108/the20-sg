              ...
              <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table className="w-full text-sm text-left text-white">
                  <tbody>
                    ...
                    <tr className="">
                      <td className="pr-4 md:pr-6 py-4 ">Business Development</td>
                      <td className="px-6 py-4">Kingsford Waterbay, Singapore</td>
                      <td className="px-6 py-4">Full Time</td>
                      <td className="px-6 py-4">
                        <a
                    ...
                    <tr className="">
                      <td className="pr-4 md:pr-6 py-4 ">Full-stack Developer</td>
                      <td className="px-6 py-4">Kingsford Waterbay, Singapore</td>
                      <td className="px-6 py-4">Full Time</td>
                      <td className="px-6 py-4">
                        <a
                    ...
                    <tr className="">
                      <td className="pr-4 md:pr-6 py-4 ">Front-end Developer</td>
                      <td className="px-6 py-4">Kingsford Waterbay, Singapore</td>
                      <td className="px-6 py-4">Full Time</td>
                      <td className="px-6 py-4">
                        <a
