        ...
        <div className="col-span-10 lg:col-span-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="">
              ...
              <div className="g-recaptcha mt-2 w-full" data-sitekey="iqeqwdkk"></div>
            </div>
          </div>
          <button
            type="button"
            className="text-black mt-5 w-full  bg-[#e5c493] ring-[#e5c493]  focus:ring-4 focus:outline-none
                            font-medium rounded text-sm px-4 py-2 text-center dark:bg-blue-600 "
          >
            Submit
          </button>
